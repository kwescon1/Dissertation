...
const AddClient = () => {
    ...
    const [useDateOrAge, setuseDateOrAge] = useState("useDate")
                    ...
                    <Form >
                      ...
                      <div className="space-y-4">
                            ...
                            <div className="block space-y-1 py-2">
                                <label htmlFor="dobAge" className="font-medium">
                                    Date of Birth / Age
                                </label>
                                <div className="flex space-x-6">
                                    <RadioInput
                                        ...
                                        label="Use Date"
                                        value="useDate"
                                        checked= {useDateOrAge === "useDate"}
                                        onChange = {(e) => (setuseDateOrAge(e.target.value))}
                                    />
                                    <RadioInput
                                        name="dobAge"
                                        id="useAge"
                                        label="Use Age"
                                        value="useAge"
                                        checked= {useDateOrAge === "useAge"}
                                        onChange = {(e) => (setuseDateOrAge(e.target.value))}
                                    />
                                </div>
                                {useDateOrAge === "useDate"  && <PageInput 
                                label=""
                                type="date"
                                placeholder=""
                                name="dateofBirth"
                                id="dateofBirth" />}
                                {useDateOrAge === "useAge" && <PageInput 
                                label=""
                                type="number"
                                placeholder="Age"
                                name="age"
